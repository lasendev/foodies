            ...
            <div className="card col-md-4">
                <div className="card-body" >
                    ...
                    <form>
                        ...
                        <div className="mb-3">
                            <label htmlFor="descrition" className="form-label">Description</label>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="number" name="price" className='form-control' onChange={onChangeHandler} value={data.price }/>.
                        </div>
